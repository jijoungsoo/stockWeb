class CreateOpt10059TwoTwos < ActiveRecord::Migration
  def change
    create_table :opt10059_two_twos , id: false ,:comment => "종목별투자자기관별요청"  do |t|
    ...
    add_index :opt10059_two_twos, [:stock_date, :stock_code] , unique: true
