class CreateRealtimePrices < ActiveRecord::Migration
  def change
    create_table :realtime_prices , options: "ENGINE=MEMORY" ,:comment => "주식시세" do |t|
      ...
      t.decimal :yesterday_contrast_trade_quantity ,:comment => "전일거래량대비(계약,주)"
    ...
    add_index :realtime_prices, [:stock_date, :stock_code ]
  end
end
