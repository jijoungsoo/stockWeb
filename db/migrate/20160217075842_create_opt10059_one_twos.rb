class CreateOpt10059OneTwos < ActiveRecord::Migration
  def change
    create_table :opt10059_one_twos, id: false ,:comment => "종목별투자자기관별요청"  do |t|
    ...
    add_index :opt10059_one_twos, [:stock_date, :stock_code] , unique: true
