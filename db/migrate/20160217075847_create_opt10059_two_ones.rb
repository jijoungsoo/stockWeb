class CreateOpt10059TwoOnes < ActiveRecord::Migration
  def change
    create_table :opt10059_two_ones, id: false ,:comment => "종목별투자자기관별요청"  do |t|
    ...
    add_index :opt10059_two_ones, [:stock_date, :stock_code] , unique: true
